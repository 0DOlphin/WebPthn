...
@app.route('/about')
def about_page():
    about_me_text = current_user.about_me
    return render_template('about.html', about_me_text=about_me_text, os=os.name, user_agent=request.headers.get('User-Agent'), time=datetime.now())
